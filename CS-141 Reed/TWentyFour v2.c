...
/*
  Translates from a number to a char
  0 being +
  1 being -
  2 being *
  and 3 being /
...
/*
  Determines if the given operators and numbers will end up equaling 24.
*/
...
/*
  This will generate all the combinations of 4 digits 1-9 and 3
...
/*
  This function will, given an optionNumber
  return the set of numbers from the debug display.
*/
int printSingleOption(int optionNumber) {
  //Create ints for each digit
  int digit1 = 1, digit2 = 1, digit3 = 1, digit4 = 1;
  //Counter for the number of correct combinations
  int counter = 1;
...
int main() {
  ...
  while(!done) {
    ...
    int numSet = printSingleOption(randomSelection);
